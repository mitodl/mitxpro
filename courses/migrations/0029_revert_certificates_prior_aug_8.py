...
def set_latest_certificate_revision(apps, schema_editor):  # noqa: ARG001
    """
    ...
    for cert in course_run_certificates_till_aug_8:
        ...
        # Since this is undo operation, so we undo the states to when the original data migration run  # noqa: E501
...
def revert_course_program_certificate_revisions(apps, schema_editor):  # noqa: ARG001
    """
    ...
    for cert in course_run_certificates_till_aug_8:
        certificate_page = get_course_certificate_cms_page(cert)
        if certificate_page:
            # Get and associate valid certificate page revision to certificates created till August 8 2022  # noqa: E501
            # The valid revision in this case is the latest revision created by August 8 2022  # noqa: E501
            cert.certificate_page_revision = get_latest_revision_by_date(

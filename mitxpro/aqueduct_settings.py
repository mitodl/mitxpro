...
class AqueductSettings(BaseSettings):
    ...
    MITOL_AUTHENTICATION_REPLY_TO_ADDRESS: str = Field(default='webmaster@localhost', validation_alias=AliasChoices('MITOL_AUTHENTICATION_REPLY_TO_ADDRESS'))
    ...
    POSTHOG_POLL_INTERVAL: int = Field(default=300, validation_alias=AliasChoices('POSTHOG_POLL_INTERVAL'))
    ...
    BASKET_EXPIRY_DAYS: int = Field(default=15, validation_alias=AliasChoices('BASKET_EXPIRY_DAYS'))
    ...
    CERTIFICATE_CREATION_DELAY_IN_HOURS: int = Field(default=48, validation_alias=AliasChoices('CERTIFICATE_CREATION_DELAY_IN_HOURS'))
    CLOUDFRONT_DIST: str | None = Field(default=None, validation_alias=AliasChoices('CLOUDFRONT_DIST'))
    COUPON_REQUEST_SHEET_ID: str | None = Field(default=None, validation_alias=AliasChoices('COUPON_REQUEST_SHEET_ID'))
    CRON_BASKET_DELETE_DAYS: str = Field(default='*', validation_alias=AliasChoices('CRON_BASKET_DELETE_DAYS'))
    CRON_BASKET_DELETE_HOURS: str = Field(default=0, validation_alias=AliasChoices('CRON_BASKET_DELETE_HOURS'))
    CRON_COURSERUN_SYNC_DAYS: str | None = Field(default=None, validation_alias=AliasChoices('CRON_COURSERUN_SYNC_DAYS'))
    CRON_COURSERUN_SYNC_HOURS: str = Field(default=0, validation_alias=AliasChoices('CRON_COURSERUN_SYNC_HOURS'))
    CRON_COURSE_CERTIFICATES_DAYS: str | None = Field(default=None, validation_alias=AliasChoices('CRON_COURSE_CERTIFICATES_DAYS'))
    ...
    CYBERSOURCE_EXPORT_SERVICE_NAME_WEIGHT: str = Field(default='high', validation_alias=AliasChoices('CYBERSOURCE_EXPORT_SERVICE_NAME_WEIGHT'))
    CYBERSOURCE_EXPORT_SERVICE_SANCTIONS_LISTS: str | None = Field(default=None, validation_alias=AliasChoices('CYBERSOURCE_EXPORT_SERVICE_SANCTIONS_LISTS'))
    ...
    DRIVE_CLIENT_ID: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_CLIENT_ID'))
    DRIVE_CLIENT_SECRET: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_CLIENT_SECRET'))  # REDACTED: name looks secret-like — set via a source, not here
    DRIVE_OUTPUT_FOLDER_ID: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_OUTPUT_FOLDER_ID'))
    DRIVE_SERVICE_ACCOUNT_CREDS: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_SERVICE_ACCOUNT_CREDS'), description='Sheets settings')
    DRIVE_SHARED_ID: str | None = Field(default=None, validation_alias=AliasChoices('DRIVE_SHARED_ID'))
    DRIVE_WEBHOOK_ASSIGNMENT_MAX_AGE_DAYS: int = Field(default=30, validation_alias=AliasChoices('DRIVE_WEBHOOK_ASSIGNMENT_MAX_AGE_DAYS'))
    DRIVE_WEBHOOK_ASSIGNMENT_WAIT: int = Field(default_factory=lambda: 60 * 5, validation_alias=AliasChoices('DRIVE_WEBHOOK_ASSIGNMENT_WAIT'))
    DRIVE_WEBHOOK_CHANNEL_ID: str = Field(default='mitxpro-sheets-app', validation_alias=AliasChoices('DRIVE_WEBHOOK_CHANNEL_ID'))
    DRIVE_WEBHOOK_EXPIRATION_MINUTES: int = Field(default_factory=lambda: 60 * 24, validation_alias=AliasChoices('DRIVE_WEBHOOK_EXPIRATION_MINUTES'))
    DRIVE_WEBHOOK_RENEWAL_PERIOD_MINUTES: int = Field(default_factory=lambda: 60 * 3, validation_alias=AliasChoices('DRIVE_WEBHOOK_RENEWAL_PERIOD_MINUTES'))
    ECOMMERCE_FORCE_PROFILE_COUNTRY: bool = Field(default=False, validation_alias=AliasChoices('ECOMMERCE_FORCE_PROFILE_COUNTRY'), description="Force the country determination code to use the user's profile only\nThis is for local testing, since your IP won't belong to a country")
    EDX_API_CLIENT_TIMEOUT: int = Field(default=60, validation_alias=AliasChoices('EDX_API_CLIENT_TIMEOUT'))
    EMAIL_BACKEND: str = Field(default='django.core.mail.backends.smtp.EmailBackend', validation_alias=AliasChoices('MITXPRO_EMAIL_BACKEND'), description='Configure e-mail settings')
    EMAIL_HOST: str = Field(default='localhost', validation_alias=AliasChoices('MITXPRO_EMAIL_HOST'))
    EMAIL_HOST_PASSWORD: str | None = Field(default=None, validation_alias=AliasChoices('MITXPRO_EMAIL_PASSWORD'))  # REDACTED: name looks secret-like — set via a source, not here
    EMAIL_HOST_USER: str = Field(default='', validation_alias=AliasChoices('MITXPRO_EMAIL_USER'))
    EMAIL_PORT: int = Field(default=25, validation_alias=AliasChoices('MITXPRO_EMAIL_PORT'))
    EMAIL_SUPPORT: str | None = Field(default=None, validation_alias=AliasChoices('MITXPRO_SUPPORT_EMAIL'))  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    ...
    GTM_TRACKING_ID: str = Field(default='', validation_alias=AliasChoices('GTM_TRACKING_ID'))
    ...
    HUBSPOT_CONFIG: Any = Field(default_factory=lambda: {
    ...
    HUBSPOT_MAX_CONCURRENT_TASKS: int = Field(default=4, validation_alias=AliasChoices('HUBSPOT_MAX_CONCURRENT_TASKS'))
    HUBSPOT_PIPELINE_ID: str = Field(default='default', validation_alias=AliasChoices('HUBSPOT_PIPELINE_ID'))
    HUBSPOT_TASK_DELAY: int = Field(default=1000, validation_alias=AliasChoices('HUBSPOT_TASK_DELAY'))
    INSTALLED_APPS: tuple[Any, ...] = Field(default=('django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes', 'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles', 'django.contrib.humanize', 'django.contrib.sites', 'django.contrib.sitemaps', 'django_user_agents', 'social_django', 'oauth2_provider', 'rest_framework', 'anymail', 'django_filters', 'wagtail.contrib.forms', 'wagtail.contrib.redirects', 'wagtail.contrib.table_block', 'wagtail.contrib.routable_page', 'wagtail.embeds', 'wagtail.sites', 'users.apps.MitxproWagtailUsersAppConfig', 'wagtail.snippets', 'wagtail.documents', 'wagtail.images', 'wagtail.search', 'wagtail.admin', 'wagtail', 'wagtailmetadata', 'modelcluster', 'taggit', 'wagtail.api.v2', 'robots', 'mitxpro', 'authentication', 'courses', 'mail.apps.MailApp', 'users', 'cms', 'compliance', 'courseware', 'sheets', 'affiliate', 'b2b_ecommerce', 'ecommerce', 'hijack', 'hijack.contrib.admin', 'hubspot_xpro', 'voucher', 'maxmind', 'mitol.hubspot_api.apps.HubspotApiApp', 'mitol.common.apps.CommonApp', 'mitol.observability.apps.ObservabilityConfig', 'mitol.digitalcredentials.apps.DigitalCredentialsApp', 'mitol.mail.apps.MailApp', 'mitol.oauth_toolkit_extensions.apps.OAuthToolkitExtensionsApp', 'mitol.authentication.apps.TransitionalAuthenticationApp', 'mitol.olposthog.apps.OlPosthog', 'django_aqueduct'), description='Application definition')  # TODO: refine type
    ...
    MITOL_COMMON_USER_FACTORY: str = Field(default='users.factories.UserFactory', description='mitol-django-common')
    MITOL_DIGITAL_CREDENTIALS_BUILD_CREDENTIAL_FUNC: str | None = Field(default=None, description='mitol-django-digital-credentials')  # REDACTED: name looks secret-like — set via a source, not here
    MITOL_HUBSPOT_API_ID_PREFIX: str = Field(default='XPRO', validation_alias=AliasChoices('MITOL_HUBSPOT_API_ID_PREFIX'))
    MITOL_HUBSPOT_API_PRIVATE_TOKEN: str | None = Field(default=None, validation_alias=AliasChoices('MITOL_HUBSPOT_API_PRIVATE_TOKEN'), description='Hubspot sync settings')  # REDACTED: name looks secret-like — set via a source, not here
    MITOL_HUBSPOT_API_RETRIES: int = Field(default=3, validation_alias=AliasChoices('MITOL_HUBSPOT_API_RETRIES'))
    ...
    MITXPRO_REPLY_TO_ADDRESS: str = Field(default='webmaster@localhost', validation_alias=AliasChoices('MITXPRO_REPLY_TO_ADDRESS'))
    MITXPRO_USE_S3: bool = Field(default=False, validation_alias=AliasChoices('MITXPRO_USE_S3'))
    NOTIFICATION_EMAIL_BACKEND: str = Field(default='anymail.backends.mailgun.EmailBackend', validation_alias=AliasChoices('MITXPRO_NOTIFICATION_EMAIL_BACKEND'))
    ...
    OAUTH2_PROVIDER: Any = Field(default=None)  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    ...
    OPENEDX_SERVICE_WORKER_USERNAME: str | None = Field(default=None, validation_alias=AliasChoices('OPENEDX_SERVICE_WORKER_USERNAME'))
    OPENEDX_SOCIAL_LOGIN_PATH: str = Field(default='/auth/login/ol-oauth2/?auth_entry=login', validation_alias=AliasChoices('OPENEDX_SOCIAL_LOGIN_PATH'))
    OPENEDX_TOKEN_EXPIRES_HOURS: int | None = Field(default=None, validation_alias=AliasChoices('OPENEDX_TOKEN_EXPIRES_HOURS'))  # REDACTED: name looks secret-like — set via a source, not here
    PASSWORD_RESET_CONFIRM_URL: str | None = Field(default=None, description='Relative URL to be used by Djoser for the link in the password reset email\n(see: http://djoser.readthedocs.io/en/stable/settings.html#password-reset-confirm-url)')  # REDACTED: name looks secret-like — set via a source, not here
    ...
    SECURE_SSL_HOST: str | None = Field(default=None, validation_alias=AliasChoices('MITXPRO_SECURE_SSL_HOST'))
    SECURE_SSL_REDIRECT: bool = Field(default=True, validation_alias=AliasChoices('MITXPRO_SECURE_SSL_REDIRECT'))
    ...
    SHEETS_DEFERRAL_FIRST_ROW: int = Field(default=5, validation_alias=AliasChoices('SHEETS_DEFERRAL_FIRST_ROW'))
    SHEETS_MONITORING_FREQUENCY: int = Field(default_factory=lambda: 60 * 60 * 2, validation_alias=AliasChoices('SHEETS_MONITORING_FREQUENCY'))
    SHEETS_REFUND_COMPLETED_DATE_COL: int = Field(default=12, validation_alias=AliasChoices('SHEETS_REFUND_COMPLETED_DATE_COL'))
    SHEETS_REFUND_ERROR_COL: int = Field(default=13, validation_alias=AliasChoices('SHEETS_REFUND_ERROR_COL'))
    SHEETS_REFUND_FIRST_ROW: int = Field(default=4, validation_alias=AliasChoices('SHEETS_REFUND_FIRST_ROW'))
    SHEETS_REFUND_PROCESSOR_COL: int = Field(default=11, validation_alias=AliasChoices('SHEETS_REFUND_PROCESSOR_COL'))
    SHEETS_REFUND_SKIP_ROW_COL: int = Field(default=14, validation_alias=AliasChoices('SHEETS_REFUND_SKIP_ROW_COL'))
    SHEETS_REQ_CALCULATED_COLUMNS: Any = Field(default=None)  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    SHEETS_REQ_EMAIL_COL: int = Field(default=7, description='Specify the zero-based index of certain request sheet columns')
    SHEETS_REQ_ERROR_COL: int = Field(default=9)
    SHEETS_REQ_ERROR_COL_LETTER: Any = Field(default=None)  # DERIVED: reproduce in a @model_validator (conditional/computed value)
    ...
    VOUCHER_COMPANY_ID: int = Field(default='1', validation_alias=AliasChoices('VOUCHER_COMPANY_ID'))
    VOUCHER_DOMESTIC_AMOUNT_KEY: str = Field(default='UNIQUE08', validation_alias=AliasChoices('VOUCHER_DOMESTIC_AMOUNT_KEY'))
    VOUCHER_DOMESTIC_COURSE_KEY: str = Field(default='UNIQUE05', validation_alias=AliasChoices('VOUCHER_DOMESTIC_COURSE_KEY'))
    VOUCHER_DOMESTIC_CREDITS_KEY: str = Field(default='UNIQUE06', validation_alias=AliasChoices('VOUCHER_DOMESTIC_CREDITS_KEY'))
    VOUCHER_DOMESTIC_DATES_KEY: str = Field(default='UNIQUE07', validation_alias=AliasChoices('VOUCHER_DOMESTIC_DATES_KEY'))
    VOUCHER_DOMESTIC_EMPLOYEE_ID_KEY: str = Field(default='UNIQUE03', validation_alias=AliasChoices('VOUCHER_DOMESTIC_EMPLOYEE_ID_KEY'))
    VOUCHER_DOMESTIC_EMPLOYEE_KEY: str = Field(default='UNIQUE02', validation_alias=AliasChoices('VOUCHER_DOMESTIC_EMPLOYEE_KEY'), description='Voucher keys for PDF parsing')
    VOUCHER_DOMESTIC_KEY: str = Field(default='UNIQUE04', validation_alias=AliasChoices('VOUCHER_DOMESTIC_KEY'))
    VOUCHER_INTERNATIONAL_COURSE_NAME_KEY: str = Field(default='UNIQUE16', validation_alias=AliasChoices('VOUCHER_INTERNATIONAL_COURSE_NAME_KEY'))
    VOUCHER_INTERNATIONAL_COURSE_NUMBER_KEY: str = Field(default='UNIQUE17', validation_alias=AliasChoices('VOUCHER_INTERNATIONAL_COURSE_NUMBER_KEY'))
    VOUCHER_INTERNATIONAL_DATES_KEY: str = Field(default='UNIQUE15', validation_alias=AliasChoices('VOUCHER_INTERNATIONAL_DATES_KEY'))

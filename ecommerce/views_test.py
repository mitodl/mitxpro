...
def test_promocoupon_get_view_returns_only_latest_promo_versions(admin_drf_client):
    ...
    CouponPaymentVersionFactory(payment=payment, coupon_type=CouponPaymentVersion.PROMO, activation_date=now_in_utc() - timedelta(days=2))
    payment_version = CouponPaymentVersionFactory(payment=payment, coupon_type=CouponPaymentVersion.PROMO, activation_date=now_in_utc() - timedelta(days=5))

    ...
    return (
      <div className="container-gray">
        ...
        <div className="row">
          ...
          <div className="col">
            {currentUser.legal_address.street_address},{" "}
            {currentUser.legal_address.city}
            {currentUser.legal_address.postal_code
              ? ` ${currentUser.legal_address.state_or_territory.slice(3)} ${
                currentUser.legal_address.postal_code
              }`
              : ""}
          </div>
        ...
        {countries && currentUser.legal_address.state_or_territory ? (
          <div className="row">
            ...
            <div className="col">
              {
                find(
                  propEq("code", currentUser.legal_address.state_or_territory),
                  find(
                    propEq("code", currentUser.legal_address.country),
                    countries
                  ).states
        ...
        <div className="row">
          ...
          <div className="col">{currentUser.profile.leadership_level}</div>
        </div>
      </div>
    )
  }

...
def test_usernameify(mocker, full_name, email, expected_username):
    """Usernameify should turn a user's name into a username, or use the email if necessary"""  # noqa: E501
...
def test_usernameify_fail():
    """Usernameify should raise an exception if the full name and email both fail to produce a username"""  # noqa: E501

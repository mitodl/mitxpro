...
def test_create_user_affiliate():
    """create_user should create a new affiliate tracking record if an affiliate id was passed in the kwargs"""  # noqa: E501
...
def test_faulty_user_qset():
    """User.faulty_courseware_users should return a User queryset that contains incorrectly configured active Users"""  # noqa: E501
    users = UserFactory.create_batch(5)
    # An inactive user should not be returned even if they lack auth and courseware user records  # noqa: E501

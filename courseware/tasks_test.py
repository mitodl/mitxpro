...
def test_create_edx_user_from_id(mocker):
    """Test that create_edx_user_from_id loads a user and calls the API method to create an edX user"""  # noqa: E501
...
def test_update_edx_user_name_async(mocker):
    """Test that change_edx_user_name_async loads a user and calls the API method to update an edX user name"""  # noqa: E501

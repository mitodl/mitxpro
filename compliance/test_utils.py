...
def mock_cybersource_wsdl(mocked_responses, settings, service_version=SERVICE_VERSION):
    ...
    """  # noqa: D401
    # in order for zeep to load the wsdl, it will load the wsdl and the accompanying xsd definitions  # noqa: E501
    with open(  # noqa: PTH123
        f"{DATA_DIR}/CyberSourceTransaction_{service_version}.wsdl"
    ) as wsdl:  # noqa: PTH123, RUF100
    ...
    with open(  # noqa: PTH123
        f"{DATA_DIR}/CyberSourceTransaction_{SERVICE_VERSION}.xsd"
    ) as xsd:  # noqa: PTH123, RUF100
        mocked_responses.add(
            mocked_responses.GET,

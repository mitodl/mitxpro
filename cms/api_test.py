...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [120, 10, None, 500, None, 1000, 0],
            [220, 50, None, 5000, None, 21000],
            [0, 10, 50, 120, 220, 500, 1000, 5000, 21000, None, None, None, None],
            [0, 10, 120, 500, 1000, None, None],
        ...
        (
            ...
            [120, 10, None, 500, None, 1000, 0],
            [220, 50, None, 5000, None, 21000],
            [21000, 5000, 1000, 500, 220, 120, 50, 10, 0, None, None, None, None],
            [1000, 500, 120, 10, 0, None, None],

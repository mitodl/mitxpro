            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text=(
                            "When checked, switches the position of the content and"
                            " video, i.e. video on left and content on right."
                        ),
                    ),
                ),
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text=(
                            "The URL of the video to display. Must be an HLS video URL."
                        ),
                        null=True,
                    ),
                ),

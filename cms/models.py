...
class AbstractCourseProgramChildPage(DisableSitemapURLMixin, Page):
    """Abstract class for Course/Program child pages"""
...
class AbstractLearningTechniquePage(AbstractCourseProgramChildPage):
    """Abstrac class for LearningTechniquePages"""
...
class AbstractForTeamsPage(AbstractCourseProgramChildPage):
    """Abstract class for ForTeamsPages"""
...
class CommonChildPageMixin(models.Model):
    """Abstract model for CommonChildPages"""

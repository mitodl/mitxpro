...
class ResourcePage(Page):
    """
    Parent page for resource pages.
    """
    ...
    def save(self, *args, **kwargs):
        ...
        self.slug = slugify("{}-{}".format(self.heading, self.title))
        super().save(*args, **kwargs)


class TermsOfServicesPage(ResourcePage):
    """
    ...
    content_panels = ResourcePage.content_panels + [StreamFieldPanel("term_of_service")]

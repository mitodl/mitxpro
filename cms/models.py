...
class AbstractCourseProgramChildPage(DisableSitemapURLMixin, Page):
    """
    Abstract base class for course and program child pages.

    This class provides shared functionality and behavior for child pages under
    course or program parent pages.

    Attributes:
        promote_panels (list): Disabled to prevent manual slug entry; slugs are autogenerated.
    """
...
class CourseProgramChildPage(AbstractCourseProgramChildPage):
    """
...
class AbstractLearningTechniquePage(AbstractCourseProgramChildPage):
    """
    Abstract base class for Learning Technique Pages.

    Defines shared functionality and structure for pages describing learning techniques.
    """
...
class LearningTechniquesPage(CourseProgramChildPage, AbstractLearningTechniquePage):
    """
...
class AbstractForTeamsPage(AbstractCourseProgramChildPage):
    """
    Abstract base class for "For Teams" pages.

    Defines the structure and functionality for pages targeting teams or B2B audiences.
    """
...
class ForTeamsPage(CourseProgramChildPage, AbstractForTeamsPage):
    """
...
class CommonChildIndexPage(CanCreatePageMixin, DisableSitemapURLMixin, Page):
    """
...
class ForTeamsCommonPage(CommonChildPageMixin, AbstractForTeamsPage):
    """
    ...
    content_panels = [
        FieldPanel("platform"),
        *AbstractForTeamsPage.content_panels,
    ]
...
class LearningTechniquesCommonPage(CommonChildPageMixin, AbstractLearningTechniquePage):
    """
    ...
    content_panels = [
        FieldPanel("platform"),
        *AbstractLearningTechniquePage.content_panels,
    ]
